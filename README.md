...
- [📖 Set up a "Hello world" project as one app with Webpack app](#-Set-up-a-"Hello-world"-project-as-one-app-with-Webpack-app-)
...
**hello-rails-back-end** is a RoR back-end application that implement a connection with [hello-react-front-end](https://github.com/Mylo16/hello-rails-front-end).
...
- GitHub: [@Mylo16](https://github.com/oovillagran)
